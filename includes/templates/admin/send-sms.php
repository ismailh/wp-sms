                    ...
                    <div class="postbox">
                        <div class="inside">
                            <div class="wpsms-sendsms__overlay">
                                <svg class="wpsms-sendsms__overlay__spinner" xmlns="http://www.w3.org/2000/svg"
                                    style="margin:auto;background:0 0" width="200" height="200" viewBox="0 0 100 100"
                                    preserveAspectRatio="xMidYMid" display="block">
                                    <circle cx="50" cy="50" fill="none" stroke="#c6c6c6" stroke-width="10" r="35"
                            ...
                            <form method="post" action="">
                                ...
                                <table class="form-table">
                                        ...
                                        <td>
                                            ...
                                            <div class="wpsms-value wpsms-group">
                                                <select name="wpsms_groups[]" multiple="true" class="js-wpsms-select2"
                                                    data-placeholder="<?php _e('Please select the Group', 'wp-sms'); ?>">
                                            ...
                                            <div class="wpsms-value wpsms-users wpsms-users-roles">
                                                <select id="wpsms_roles" name="wpsms_roles[]" multiple="true"
                                                    class="js-wpsms-select2"
                                                    data-placeholder="<?php _e('Please select the Role', 'wp-sms'); ?>">
                                                    <?php
                                                    foreach ($wpsms_list_of_role as $key_item => $val_item):
                                                        ?>
                                                    <option
                                                        value="<?php echo $key_item; ?>"
                                            ...
                                            <span class="wpsms-value wpsms-numbers">
                                                ...
                                                <textarea cols="80" rows="5" style="direction:ltr;margin-top: 10px;"
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <textarea dir="auto" cols="80" rows="5" wrap="hard"
                                                name="wp_get_message wpsms-input" id="wp_get_message"></textarea><br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="margin-top: 11px;">
                                                <a href="#" class="wpsms-remove-button button"
                                    ...
                                    <tr class="repeat-subfield" valign="top">
                                        ...
                                        <td>
                                            <input type="text" id="repeat_ends_on" readonly="readonly"
                                                name="wpsms_repeat_ends_on">
                                            <input type="checkbox" name="" id="repeat-forever"><label
                                                for="repeat-forever"><?php _e('Repeat Forever', 'wp-sms')?></label>
                                        </td>
                                    </tr>
                                    <?php else: ?>
                                    <tr id=" schedule" valign="top">
